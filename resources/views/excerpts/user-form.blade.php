<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from mironmahmud.com/classicads/assets/ltr/user-form.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 16:10:16 GMT -->
<!-- Added by HTTrack -->
...
<body>
    <section class="user-form-part">
        ...
        <div class="user-form-category">
            <div class="user-form-header"><a href="#"><img src="images/logo.png" alt="logo"></a><a
                    href="index.html"><i class="fas fa-arrow-left"></i></a></div>
            ...
            <div class="tab-pane active" id="login-tab">
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group text-right"><a href="#" class="form-forgot">Forgot
                                    password?</a></div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="form-group"><input type="password" class="form-control"
                                    placeholder="Password"><button class="form-icon"><i
                                        class="eye fas fa-eye"></i></button><small class="form-alert">Password must be
                                    6 characters</small></div>
                        </div>
                        <div class="col-12">
                            <div class="form-group"><input type="password" class="form-control"
