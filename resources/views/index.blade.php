            ...
            <div class="header-content">
                <div class="header-left">
                    <button type="button" class="header-widget sidebar-btn">
                        <i class="fas fa-align-left"></i></button><a href="index.html" class="header-logo"><img
                            src="images/logo.png" alt="logo" /></a><a href="user-form.html"
                        class="header-widget header-user"><img src="images/user.png" alt="user" /><span>join
                            me</span></a><button type="button" class="header-widget search-btn">
                ...
                <form class="header-form">
                    <div class="header-search">
                        <button type="submit" title="Search Submit ">
                            <i class="fas fa-search"></i></button><input type="text"
                ...
                <div class="header-right">
                    ...
                    <a href="ad-post.html" class="btn btn-inline post-btn"><i
                            class="fas fa-plus-circle"></i><span>List Company</span></a>
                </div>
            </div>
        </div>
    </header>
    ...
    <nav class="mobile-nav">
        <div class="container">
            <div class="mobile-group">
                <a href="index.html" class="mobile-widget"><i class="fas fa-home"></i><span>home</span></a><a
                    href="user-form.html" class="mobile-widget"><i class="fas fa-user"></i><span>join me</span></a><a
                    ...
                    class="mobile-widget"><i class="fas fa-envelope"></i><span>message</span><sup>0</sup></a>
            </div>
        </div>
    </nav>
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="img/slider/1600.png" alt="Available Largest Saudi Executive Database"
                        ...
                        <div class="carousel-caption slider-cap">
                            ...
                            <a href="" class="hs2" data-toggle="modal" data-target="#myModal">Company
                                Owners</a>
                            <a href="" class="hs1" data-toggle="modal"
                                data-target="#myModal">Presidents</a>
    ...
    <section class="suggest-part">
        <div class="container">
            <div class="suggest-slider slider-arrow">
                <a href="ad-list-column3.html" class="suggest-card"><img src="images/suggest/automobile.png"
                        alt="car" />
                    <h6>automobile</h6>
                    <p>(4,521)</p>
                </a><a href="ad-list-column3.html" class="suggest-card"><img src="images/suggest/furniture.png"
                        alt="furniture" />
                    <h6>furniture</h6>
                    <p>(4,521)</p>
                </a><a href="ad-list-column3.html" class="suggest-card"><img src="images/suggest/properties.png"
                        alt="house" />
                    <h6>properties</h6>
                    <p>(4,521)</p>
                </a><a href="ad-list-column3.html" class="suggest-card"><img src="images/suggest/fashion.png"
                        alt="food" />
                    <h6>fashion</h6>
                    <p>(4,521)</p>
                </a><a href="ad-list-column3.html" class="suggest-card"><img src="images/suggest/electronics.png"
                        alt="cycle" />
                    <h6>electronics</h6>
                    <p>(4,521)</p>
                </a><a href="ad-list-column3.html" class="suggest-card"><img src="images/suggest/hospitality.png"
                        alt="clothes" />
                    <h6>hospitality</h6>
                    <p>(4,521)</p>
                </a><a href="ad-list-column3.html" class="suggest-card"><img src="images/suggest/gadgets.png"
                        alt="computer" />
                    <h6>gadgets</h6>
                    <p>(4,521)</p>
                </a><a href="ad-list-column3.html" class="suggest-card"><img src="images/suggest/education.png"
                        alt="phone" />
                    <h6>education</h6>
                    <p>(4,521)</p>
                </a><a href="ad-list-column3.html" class="suggest-card"><img src="images/suggest/software.png"
                        alt="scooter" />
                    <h6>software</h6>
                    <p>(4,521)</p>
                </a><a href="ad-list-column3.html" class="suggest-card"><img src="images/suggest/food.png"
                        alt="television" />
                    <h6>food</h6>
                    <p>(4,521)</p>
                </a><a href="ad-list-column3.html" class="suggest-card"><img src="images/suggest/services.png"
                        alt="truck" />
                    <h6>services</h6>
                    <p>(4,521)</p>
                </a><a href="ad-list-column3.html" class="suggest-card"><img src="images/suggest/animals.png"
                        alt="pet" />
                    <h6>animals</h6>
                    <p>(4,521)</p>
                </a>
