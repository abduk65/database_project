...
<head>
    <title> Register : Saudi Executive Contact database </title>
        ...
        <div class="container top-search-main">
            <div class="row">
                <div class="ts-menu">
                    ...
                    <!--<div class="ts-menu-1" style="height:85px;">
                                <a href="" style="height:52px; width:164px; text-decoration:none;"><img src="images/inner-logo.png" alt="" style="height:52px; width:164px; text-decoration:none;"> </a>
                        </div>
                        <div class="ts-menu-3">
                                <div class="">
                                        &nbsp;
                    ...
                    <div class="v3-m-1" style="height:85px;width:30%; padding-top:9.5px;">
                        <a href=""><img src="images/taajer_logo.jpg" alt="" class="hasimg"> </a>
                    </div>
                    <div class="v3-m-1">
                        &nbsp;
                    </div>
                    <div class="v3-m-2" style="width:69%;">
                        <div class="v3-top-ri" style="margin-right:0px; padding-top:15px;">
                            <ul>
                                <!--<li><a href="register" class="v3-menu-sign"><i class="fa fa-user-plus"></i> Register</a> </li>-->
                                <li><a href="login" class="v3-menu-sign"><i class="fa fa-sign-in"></i> Sign In</a>
                                </li>
                                <li><a href="packages"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Buy Now
                    ...
                    <!--<div class="mob-right-nav" data-wow-duration="0.5s">
                            ...
                            <ul class="mob-menu-icon">
                                <li><a href="listing">Add Business</a> </li>
                                <li><a href="register" data-toggle="modal" data-target="#register">Register</a> </li>
                                <li><a href="login" data-toggle="modal" data-target="#sign-in">Sign In</a> </li>
                            </ul>
                            <h5>Taajer</h5>
                            <ul>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-4 col-md-3 foot-logo">
                                        ...
                                        <p class="hasimg"> <img src="images/paypal-secure-payments.png"
                                                alt="payment"> </p>
                                    </div>
                    ...
                    <div class="modal-body dir-pop-body">
                        <form method="post" class="form-horizontal">
                            ...
                            <div class="form-group has-feedback ak-field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="fname1" placeholder=""
                                        required>
                                </div>
                            </div>
                            <!--LISTING INFORMATION-->
                            <div class="form-group has-feedback ak-field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="mobile1" placeholder="">
                                </div>
                            </div>
                            <!--LISTING INFORMATION-->
                            <div class="form-group has-feedback ak-field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="email1" placeholder="">
                                </div>
                            </div>
                            <!--LISTING INFORMATION-->
                            <div class="form-group has-feedback ak-field">
